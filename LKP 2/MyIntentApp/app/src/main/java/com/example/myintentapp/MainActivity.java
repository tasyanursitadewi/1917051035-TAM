    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btn_move_activity_data:
                Intent moveWithDataIntent = new Intent(MainActivity.this,MoveWithDataAcivity.class);
                moveWithDataIntent.putExtra(MoveWithDataAcivity.EXTRA_NAME, "DicodingAcademy Boy");
                moveWithDataIntent.putExtra(MoveWithDataAcivity.EXTRA_AGE, 5);
